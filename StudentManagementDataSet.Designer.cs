...
namespace NguyenHungPhat68PM3 {
    ...
    public partial class StudentManagementDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, int Age, string Gender, string Major) {
...
namespace NguyenHungPhat68PM3.StudentManagementDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [Age], [Gender], [Major]) VALUES (@Name, @A" +
                "ge, @Gender, @Major);\r\nSELECT StudentId, Name, Age, Gender, Major FROM Students " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Name] = @Name, [Age] = @Age, [Gender] = @Gender, [Major] = @Major WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Major = 1 AND [Major] IS NULL) OR ([Major] = @Original_Major)));
SELECT StudentId, Name, Age, Gender, Major FROM Students WHERE (StudentId = @StudentId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NguyenHungPhat68PM3.Properties.Settings.Default.StudentManagementConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, Name, Age, Gender, Major FROM dbo.Students";
        ...
        public virtual int Fill(StudentManagementDataSet.StudentsDataTable dataTable) {
        ...
        public virtual StudentManagementDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentManagementDataSet.StudentsDataTable dataTable = new StudentManagementDataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentManagementDataSet.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_StudentId, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Gender, string Original_Major) {
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Age, string Gender, string Major) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Age, string Gender, string Major, int Original_StudentId, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Gender, string Original_Major, int StudentId) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Age, string Gender, string Major, int Original_StudentId, string Original_Name, global::System.Nullable<int> Original_Age, string Original_Gender, string Original_Major) {
            return this.Update(Name, Age, Gender, Major, Original_StudentId, Original_Name, Original_Age, Original_Gender, Original_Major, Original_StudentId);
        }
    }
...
SELECT Id, Username, Password FROM Users WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(StudentManagementDataSet.UsersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual StudentManagementDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentManagementDataSet.UsersDataTable dataTable = new StudentManagementDataSet.UsersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentManagementDataSet.UsersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
